...
import SweetPotatoes from '../RootTubers/SweetPotatoes';

class SweetPotatoesVines extends Component {
    render(){
        return (
            <div className=''>
                <div class="ltn__product-area ltn__product-gutter mb-120 mt-30">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-sm-6 col-6">
                                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                                        ...
                                                        <div class="product-info">
                                                            ...
                                                            <div className=''>
                                                                <a href="#" className="mr-4" title="Quick View" data-bs-toggle="modal" data-bs-target="#quick_view_modal">
                                                                    <i class="far fa-eye"></i>
                                                                </a> &nbsp; &nbsp; &nbsp; &nbsp;
                                                                <a href="#" className="mr-4" title="Add to Cart" data-bs-toggle="modal" data-bs-target="#add_to_cart_modal">
...
export default SweetPotatoesVines;